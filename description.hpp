...
void description_parse_neuron(const std::string &id, const YAML::Node attributes, NeuronGroup &neuron_group);
...
void description_parse_edge(const std::string &description, const YAML::Node edge_node, Network &network);
